    ...
    <footer className="bg-primary text-secondary py-16 px-6 md:px-12 mt-auto">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-secondary/10 pb-12">
        <div className="md:col-span-2">
          <Link
            to="/"
            className="font-serif text-3xl tracking-widest block mb-4"
          >
            YOUR
            <span className="text-secondary/60 italic font-light ml-1">
              TIME
            </span>
          </Link>
        ...
        <div>
          <h4 className="font-sans text-xs tracking-widest uppercase mb-6 text-secondary/50">
            Explore
          </h4>
