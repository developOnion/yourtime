    ...
    <div className="w-full">
      ...
      <section className="py-24 px-6 md:px-12 bg-secondary text-center max-w-4xl mx-auto">
        <h2 className="text-2xl md:text-4xl text-primary font-serif leading-relaxed font-light mb-8">
          We believe the environment dictates the experience. Our portfolio of architectural masterpieces offers a blank canvas for your most significant celebrations.
        </h2>
      ...
      <section className="py-20 px-6 md:px-12 bg-[#EAE8E4]">
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-end mb-16">
            <div>
              <p className="tracking-widest uppercase text-xs text-primary/60 mb-2 font-semibold">The Collection</p>
              <h3 className="text-4xl font-serif text-primary">Featured Venues</h3>
            </div>
            <Link to="/venues" className="hidden md:flex items-center text-sm uppercase tracking-widest border-b border-primary/20 pb-1 hover:border-accent transition-colors duration-300">
          ...
          <div className="mt-12 text-center md:hidden">
            <Link to="/venues" className="inline-flex items-center text-xs uppercase tracking-widest border border-primary px-8 py-4 hover:bg-primary hover:text-secondary transition-colors duration-300">
              View All Venues
            </Link>
          </div>
        </div>
